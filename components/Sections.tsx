...
export function TeamSection() {
  return (
    <div className="py-24 bg-white border-t border-slate-100" id="team">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-16 animate-fade-in-up">
          <span className="inline-block px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-700 font-bold text-xs uppercase tracking-wider mb-4">
            Project Creator
          </span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
            Meet The Creator
          </h2>
          <p className="text-slate-600 mt-3 text-base font-medium max-w-xl mx-auto">
            Verify Your Cart was conceived and developed as an intelligent consumer safety project.
          </p>
        </div>

        <div className="max-w-md mx-auto">
          <div className="bg-gradient-to-b from-slate-50 to-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 text-center relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            <div className="w-24 h-24 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 text-white font-black text-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-500/30">
              SV
            </div>
            ...
            <p className="text-sm font-bold text-blue-600 uppercase tracking-wide mb-4">
              Project Creator / Developer
            </p>

            <div className="inline-block px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-xs font-semibold mb-6">
              Full-Stack & AI Security Engineering
            </div>

            <p className="text-slate-600 text-sm leading-relaxed mb-6 font-medium">
              Passionate about creating intelligent systems that protect digital shoppers from counterfeit merchandise, manipulated reviews, and predatory e-commerce traps.
            </p>

            <a
              href="mailto:sakethvedullapalli@gmail.com"
              className="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full bg-slate-900 hover:bg-blue-600 text-white font-bold text-xs transition-all shadow-md active:scale-95"
            >
...
export function ContactSection() {
  ...
  return (
    <div className="py-24 bg-slate-50" id="contact">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-10 md:p-14 bg-slate-900 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <span className="text-blue-400 font-bold uppercase tracking-widest text-xs mb-4 block">Get In Touch</span>
                <h2 className="text-3xl md:text-4xl font-extrabold mb-4 tracking-tight">Have Questions or Suggestions?</h2>
                <p className="text-slate-400 mb-10 leading-relaxed font-medium text-base">
                  Verify Your Cart is maintained by Saketh Vedullapalli. Reach out for feedback, collaborations, or feature proposals.
                </p>

                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="bg-white/10 p-3.5 rounded-2xl text-blue-400">
                      <Mail size={22} />
                    </div>
                    <div>
                      <h4 className="font-bold text-white text-base">Direct Email</h4>
                      <a href="mailto:sakethvedullapalli@gmail.com" className="text-slate-400 hover:text-white transition-colors text-sm font-medium">
                        sakethvedullapalli@gmail.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="bg-white/10 p-3.5 rounded-2xl text-purple-400">
                      <MapPin size={22} />
                    </div>
                    <div>
                      <h4 className="font-bold text-white text-base">Project Location</h4>
                      <p className="text-slate-400 text-sm font-medium">Andhra Pradesh, India</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-10 md:p-14 bg-white">
              <h3 className="font-extrabold text-2xl text-slate-900 mb-6 tracking-tight">Send a Message</h3>
              ...
              {submitted ? (
                <div className="p-8 rounded-2xl bg-emerald-50 border border-emerald-200 text-center">
                  ...
                  <h4 className="font-bold text-emerald-900 text-lg mb-2">Message Delivered!</h4>
                  <p className="text-emerald-700 text-sm mb-6">
                    Thank you! Your inquiry has been sent to Saketh Vedullapalli. We will review your message shortly.
                  </p>
                  <button
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-5 py-3.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-slate-50 focus:bg-white text-sm"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      name="message"
                      placeholder="How can we help or what feedback do you have?"
                      rows={4}
                      className="w-full px-5 py-3.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-slate-50 focus:bg-white text-sm"
                      required
                    />
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-slate-900 hover:bg-blue-600 text-white font-bold py-4 rounded-xl transition-all shadow-lg active:scale-[0.98] flex items-center justify-center gap-2 text-sm"
                  >
